...
from Tipigo_Dashboard_Project.risk_free import compute_risk_free_rate


class HapoalimActions:
    ...
    def pipeline(self, mapped_data: pd.DataFrame, stock_prices: pd.DataFrame, initial_cash, risk_free_rate_file):
    ...
    def create_monthly(self, data, benchmarks):
